...
//    static final int MAX_PROP = 36;
    ...
    int doublesCount;               // number of current times consecutively rolling a double
    boolean jail;                   // set whether the player is in jail
    int doublesInJailCount;         // num rolls in jail trying to roll a double to get out
    ...
    public Player(String name){
        ...
        doublePayCard = false;
        noPayCard = false;
        doublesCount = 0;         // number of doulbes whle out of jail
        doublesInJailCount = 0;   // number of doubles while in jail
        jail = false;             // in-jail status
    }
    ...
    /**
     * This method increments the consecutively rolled doubles while in jail
     * @return current consecutive double count after increment
     */
   public int upJailDoubleCount(){
     return this.doublesInJailCount++;
   }
    ...
    * @return current consecutive double count after increment
    */
  public int getJailDoubleCount(){
    return this.doublesInJailCount;
  }

   /**
    * This method resets the consecutively rolled doubles in jail to zero
    * @return current consecutive double count after increment is now zero
    */
  public int resetJailDoubleCount(){
    return doublesInJailCount = 0;
  }

    /**
     * This method increments the consecutively rolled doubles
     * @return current consecutive double count after increment
     */
   public int upDoubleCount(){
     return this.doublesCount++;
   }

   /**
    * This method resets the consecutively rolled doubles to zero
    * @return current consecutive double count reset to zero
    */
   public int resetDoublesCount(){
     return doublesCount = 0;
   }

   /**
    * This method checks the current amount of consecutively rolled doubles
    * @return current consecutive double count
    */
   ...
   /**
    * This method puts the player's status as in jail
    * @return set player's status as in the jail
    */
   ...
   public boolean inJail(){
       return this.jail = true;
   }

   /**
    * This method puts the player's status as out jail
    * @return set player's status as out of the jail
    */
   public boolean outJail(){
       return this.jail = false;
   }
