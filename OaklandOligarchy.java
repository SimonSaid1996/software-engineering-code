...
public class OaklandOligarchy implements Runnable {
    ...
    */
    ...
    @Override
    public void run() {
        frame.setSize(1600, EIGHT_HUNDRED);
        panel = new JPanel(new GridBagLayout());

        setUpPlayers();     // call player set up

        //game board
        addGridPrameter(ONE, 11, ZERO, HUNDRED_TWENTY, EIGHTY);     //Call method: addGridPrameter()

        //status bar
        addGridPrameter(TWO, ZERO, ZERO, 10, FOURTY);     //Call method: addGridPrameter()
